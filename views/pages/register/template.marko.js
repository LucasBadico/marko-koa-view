...
var marko_template = module.exports = require("marko/html").t(__filename),
    ...
    app_register_template = marko_loadTemplate(require.resolve("../../components/app-register")),
    app_register_tag = marko_loadTag(app_register_template),
