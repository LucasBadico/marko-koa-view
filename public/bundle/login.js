...
$_mod.def("/behealth$0.0.1/views/components/app-login/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.0.0-rc.18 - DO NOT EDIT
var marko_template = module.exports = require('/marko$4.0.0-rc.18/vdom'/*"marko/vdom"*/).t(),
    marko_component = {
        onInput: function(input) {
          return {
    ...
    marko_widgets = require('/marko$4.0.0-rc.18/widgets/index-browser'/*"marko/widgets"*/),
    marko_registerWidget = marko_widgets.rw,
    marko_widgetType = marko_registerWidget("/behealth$0.0.1/views/components/app-login/index.marko", function() {
      return module.exports;
    }),
    marko_helpers = require('/marko$4.0.0-rc.18/runtime/vdom/helpers'/*"marko/runtime/vdom/helpers"*/),
    marko_createElement = marko_helpers.e,
    marko_const = marko_helpers.const,
    marko_const_nextId = marko_const("b04b10"),
    marko_node0 = marko_createElement("div", {
        "class": "container"
      }, 1, marko_const_nextId())
      .e("div", {
