$_mod.def("/fullstack-challenge$1.0.0/public/views/components/number-spinner/index", function(require, exports, module, __filename, __dirname) { // We can include a CSS file just by requiring it. Sweet!
...
module.exports = require('/marko-widgets$6.6.0/lib/index-browser'/*'marko-widgets'*/).defineComponent({
    // Use the following template to render our UI component
    template: require('/fullstack-challenge$1.0.0/public/views/components/number-spinner/template.marko'/*'./template.marko'*/),
