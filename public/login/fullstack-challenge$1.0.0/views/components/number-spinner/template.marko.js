$_mod.def("/fullstack-challenge$1.0.0/views/components/number-spinner/template.marko", function(require, exports, module, __filename, __dirname) { function create(__helpers) {
  var __widgetType = {
          name: "/fullstack-challenge$1.0.0/views/components/number-spinner/index",
          def: function() {
            return require('/fullstack-challenge$1.0.0/views/components/number-spinner/index'/*"./index.js"*/);
          }
        },
