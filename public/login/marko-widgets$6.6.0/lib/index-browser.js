$_mod.def("/marko-widgets$6.6.0/lib/index-browser", function(require, exports, module, __filename, __dirname) { /*
...
var EMPTY_OBJ = {};
var Widget = require('/marko-widgets$6.6.0/lib/Widget'/*'./Widget'*/);
var initWidgets = require('/marko-widgets$6.6.0/lib/init-widgets-browser'/*'./init-widgets'*/);
var raptorRenderer = require('/raptor-renderer$1.4.6/lib/raptor-renderer'/*'raptor-renderer'*/);
var updateManager = require('/marko-widgets$6.6.0/lib/update-manager'/*'./update-manager'*/);

// Exports:
var WidgetsContext = exports.WidgetsContext = require('/marko-widgets$6.6.0/lib/WidgetsContext'/*'./WidgetsContext'*/);
...
exports.registerWidget = require('/marko-widgets$6.6.0/lib/registry'/*'./registry'*/).register;
exports.makeRenderable = exports.renderable = raptorRenderer.renderable;
exports.render = raptorRenderer.render;
exports.defineComponent = require('/marko-widgets$6.6.0/lib/defineComponent'/*'./defineComponent'*/);
exports.defineWidget = require('/marko-widgets$6.6.0/lib/defineWidget-browser'/*'./defineWidget'*/);
exports.defineRenderer = require('/marko-widgets$6.6.0/lib/defineRenderer'/*'./defineRenderer'*/);
