$_mod.def("/marko-widgets$6.6.0/lib/defineRenderer", function(require, exports, module, __filename, __dirname) { /*
...
var marko = require('/marko$3.14.2/runtime/marko-runtime'/*'marko'*/);
...
module.exports = function defineRenderer(def) {
    ...
    renderer.render = function(data, callback) {
        if(!callback) {
            require('/marko-widgets$6.6.0/lib/deprecate'/*'./deprecate'*/).warn(
