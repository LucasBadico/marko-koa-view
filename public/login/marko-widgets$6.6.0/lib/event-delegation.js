$_mod.def("/marko-widgets$6.6.0/lib/event-delegation", function(require, exports, module, __filename, __dirname) { var _addEventListener = require('/marko-widgets$6.6.0/lib/addEventListener'/*'./addEventListener'*/);
...
var attachBubbleEventListeners = function() {
    ...
    require('/marko-widgets$6.6.0/lib/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
