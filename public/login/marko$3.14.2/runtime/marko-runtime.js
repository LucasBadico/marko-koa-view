$_mod.def("/marko$3.14.2/runtime/marko-runtime", function(require, exports, module, __filename, __dirname) { /*
...
var helpers = require('/marko$3.14.2/runtime/helpers'/*'./helpers'*/);
...
var stream = require('/marko$3.14.2/runtime/stream/index-browser'/*'./stream'*/);
...
Template.prototype = {
    ...
    render: function(data, out, callback) {
        if(typeof out === 'function') {
            require('/marko$3.14.2/runtime/deprecate'/*'./deprecate'*/).warn(
...
require('/marko$3.14.2/runtime/deprecate'/*'./deprecate'*/)(
    Template.prototype,
    'renderSync',
...
loader = require('/marko$3.14.2/runtime/loader/index-browser'/*'./loader'*/);
